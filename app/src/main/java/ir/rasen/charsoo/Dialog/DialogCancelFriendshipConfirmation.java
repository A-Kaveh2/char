...
public class DialogCancelFriendshipConfirmation extends MyDialogOkCancel {
    ...
    @SuppressLint("NewApi")
    public DialogCancelFriendshipConfirmation(final Context context, final int requestedUserId, final IWebserviceResponse iWebserviceResponse, final ProgressDialog progressDialog, final ICancelFriendship iCancelFriendship) {
        ...
        textViewOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TestUnit.isTesting)
                    new RequestCancelFriendship(LoginInfo.getUserId(context),requestedUserId,iWebserviceResponse,iCancelFriendship).execute();
                else {
