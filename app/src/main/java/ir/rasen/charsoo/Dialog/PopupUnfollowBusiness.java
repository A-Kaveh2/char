...
public class PopupUnfollowBusiness extends MyPopup {
    ...
    @SuppressLint("NewApi")
    public PopupUnfollowBusiness(final Context context, final int businessId, final IWebserviceResponse iWebserviceResponse, final ProgressDialog progressDialog, final IUnfollowBusiness iUnfollowBusiness) {
        super(context);
        ...
        textViewUnfriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogUnfollowBusinessConfirmation d = new DialogUnfollowBusinessConfirmation(context,businessId,iWebserviceResponse,progressDialog,iUnfollowBusiness);
                d.show();
                dismiss();
            }
        });
