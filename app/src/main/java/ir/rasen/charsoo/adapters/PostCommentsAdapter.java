 ...
 */
public class PostCommentsAdapter extends BaseAdapter implements ICommentChange {
    ...
    public PostCommentsAdapter(Context context, int postOwnerBusinessId, ArrayList<Comment> comments, IWebserviceResponse IWebserviceResponse, ProgressDialog progressDialog) {
