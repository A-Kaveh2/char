 ...
 */
public class UserReviewAdapter extends BaseAdapter implements  IReviewChange {
    ...
    public UserReviewAdapter(Context context, ArrayList<Review> reviews, IWebserviceResponse iWebserviceResponse,ProgressDialog progressDialog) {
